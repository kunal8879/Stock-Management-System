            ...
            <div class="modal-body">
                <form action="actions/add_supplier.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="supplier_add" name="supplier_add"
...
<!-- search for supplier -->
<div class="mb-3">
    <input type="text" class="form-control supplier-search" id="search" onkeyup="tableSearch()"
        ...
        <tr>
            ...
            <td>
                ...
                <button type="button" class="btn btn-success" data-bs-toggle="modal"
                    data-bs-target="#editSupplierModal<?php echo $supplier['supplier_id']; ?>"
                    style=" margin: 0px 1px; padding: 4px 7px; font-size: 15px;">Edit</button>

                <!-- edit supplier model -->
                <div class="modal fade" id="editSupplierModal<?php echo $supplier['supplier_id']; ?>" aria-labelledby="myModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form action="./actions/edit_supplier.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control" id="supplier_add" name="supplier_add"
                                            value="<?php echo $supplier['supplier_add']; ?>">
                                        <label class="form-label">ADDRESS:</label>
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" id="supplier_phone" name="supplier_phone"
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control" id="added_on" name="added_on"
                                            value="<?php echo $supplier['added_on']; ?>" readonly>
                                        <label class="form-label">ADDED ON:</label>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn" data-bs-dismiss="modal"
                ...
                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                    data-bs-target="#deleteSupplierModal<?php echo $supplier['supplier_id']; ?>"
                    style=" margin: 1px; padding: 5px; font-size: 13px;">DELETE</button>

                <!-- delete supplier model -->
                <div class="modal fade" id="deleteSupplierModal<?php echo $supplier['supplier_id']; ?>"
