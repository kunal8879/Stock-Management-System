        ...
        ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#allocateItemModal" style=" margin: 0px 1px; padding: 4px 7px; font-size: 15px;">Allocate</button>
                                ...
                                <div class="modal-content" style="width: 80%; left: 10%;">
                                    ...
                                    <div class="modal-body">
                                        <form action="./actions/allocate_item.php" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" style=" margin-left: 6px; font-size: 15px;">Choose Lab: </label>
                                                ...
                                                ?>
                                                    <option value="<?php echo $allocateItem['lab_id']; ?>"><?php echo $allocateItem['lab_no']; ?></option>
                                                <?php }
                                                echo "</select>";
                                                ?>
                                            </div>
