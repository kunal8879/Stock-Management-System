...
<div class="mb-3">
    <input type="text" class="form-control item-search" id="search" onkeyup="tableSearch()"
        placeholder="Search for item.." style="width: 15%; height: 25px; float: right; margin: -38px 110px 5px 3px;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#allocateItemModal"
                    style=" margin: 0px 1px; padding: 4px 7px; font-size: 15px;">Allocate</button>

                <!-- allocate item model -->
                <div class="modal fade" id="allocateItemModal" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form action="./actions/allocate_item.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="allocate_item" class="btn btn-primary"
                                            style="background-color: #00b3aa;">Allocate</button>
                                    </div>
                                </form>
                            </div>
                        </div>
