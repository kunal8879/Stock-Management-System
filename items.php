            ...
            <div class="modal-body">
                <form action="./actions/add_item.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="item-cat" name="item_cat"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="bill_no" name="bill_no" placeholder="Enter Bill No."
                            required>
                    </div>
                    <div class="mb-3">
...
<!-- search for item -->
<div class="mb-3">
    <input type="text" class="form-control item-search" id="search" onkeyup="tableSearch()"
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <!-- edit item model -->
                <div class="modal fade" id="editItemModal<?php echo $item['item_id']; ?>" aria-labelledby="myModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form action="./actions/edit_item.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control" id="item_cat" name="item_cat"
                                            value="<?php echo $item['item_cat']; ?>">
                                        <label class="form-label">CATEGORY:</label>
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" id="item_detail" name="item_detail"
                                            value="<?php echo $item['item_detail']; ?>">
                                        <label class="form-label">DETAILS:</label>
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" id="bill_no" name="bill_no"
                                            value="<?php echo $item['bill_no']; ?>">
                                        <label class="form-label">Bill No:</label>
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" id="supplied_at" name="supplied_at"
                                            value="<?php echo $item['supplied_at']; ?>" readonly>
                ...
                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                    data-bs-target="#deleteItemModal<?php echo $item['item_id']; ?>"
                    style=" margin: 1px; padding: 5px; font-size: 13px;">DELETE</button>

                <!-- delete item model -->
                <div class="modal fade" id="deleteItemModal<?php echo $item['item_id']; ?>"
