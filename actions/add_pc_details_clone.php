...
<body>
    ...
    Lab No: $roomno
        ...
        for ($i = 1; $i <= $pcquantity; $i++) {
            ...
            echo "<button class='icon_button' ><a href='add_pc_details.php?lab_no=$roomno&& id=$i' style='text-decoration: none; color:inherit;><i id='pcicon$i' class='fa-solid fa-desktop  fa-2x '></i></a></button>";
            echo " ";
            if ($i % 5 == 0) {
                echo "<br>";
            }
